...
class App(AppBase):
    ...
    def register_views(self):
        ...
        view_widgets_01 = [
                ...
                IPNetworkWidget(   "ipnet_01", "IPNetwork         ", 20, "", data),
                IntegerWidget(   "int_val_01", "Integer           ", 20, "", data),
                FloatWidget(   "float_val_01", "Float             ", 20, "", data),
                IPAddressWidget(  "ipaddr_01", "IPAddr            ", 20, "", data),
                TimeOfDayWidget(     "tod_01", "Time Of Day (24h) ", 20, "", data),
                TextWidget(         "text_01", "Text              ", 20, "", data),
                ToggleWidget(     "toggle_01", "Toggle            ", 3, "", data, ['ENABLED', "DISABLED"], "DISABLED"),
                IPNetworkWidget(   "ipnet_02", "IPNetwork         ", 20, "", data),
                IntegerWidget(   "int_val_02", "Integer           ", 20, "", data),
                FloatWidget(   "float_val_02", "Float             ", 20, "", data),
                IPAddressWidget(  "ipaddr_02", "IPAddr            ", 20, "", data),
                TimeOfDayWidget(     "tod_02", "Time Of Day (24h) ", 20, "", data),
                TextWidget(         "text_02", "Text              ", 20, "", data),
                ToggleWidget(     "toggle_02", "Toggle            ", 3, "", data, ['ENABLED', "DISABLED"], "DISABLED"),
                IPNetworkWidget(   "ipnet_03", "IPNetwork         ", 20, "", data),
                IntegerWidget(   "int_val_03", "Integer           ", 20, "", data),
                FloatWidget(   "float_val_03", "Float             ", 20, "", data),
                IPAddressWidget(  "ipaddr_03", "IPAddr            ", 20, "", data),
                TimeOfDayWidget(     "tod_03", "Time Of Day (24h) ", 20, "", data),
                TextWidget(         "text_03", "Text              ", 20, "", data),
                ToggleWidget(     "toggle_03", "Toggle            ", 3, "", data, ['ENABLED', "DISABLED"], "DISABLED"),
                IPNetworkWidget(   "ipnet_04", "IPNetwork         ", 20, "", data),
                IntegerWidget(   "int_val_04", "Integer           ", 20, "", data),
                FloatWidget(   "float_val_04", "Float             ", 20, "", data),
                IPAddressWidget(  "ipaddr_04", "IPAddr            ", 20, "", data),
                TimeOfDayWidget(     "tod_04", "Time Of Day (24h) ", 20, "", data),
                TextWidget(         "text_04", "Text              ", 20, "", data),
                ToggleWidget(     "toggle_04", "Toggle            ", 3, "", data, ['ENABLED', "DISABLED"], "DISABLED"),
        ...
        view_widgets_02 = [
                ...
                IPNetworkWidget(     "ipnet_11", "IPNetwork         ", 20, "", data),
                IntegerWidget(     "int_val_11", "Integer           ", 20, "", data),
                FloatWidget(     "float_val_11", "Float             ", 20, "", data),
                IPAddressWidget(    "ipaddr_11", "IPAddr            ", 20, "", data),
                TimeOfDayWidget(       "tod_11", "Time Of Day (24h) ", 20, "", data),
                TextWidget(           "text_11", "Text              ", 20, "", data),
                ToggleWidget(       "toggle_11", "Toggle            ", 3, "", data, ['ENABLED', "DISABLED"], "DISABLED"),
                IPNetworkWidget(     "ipnet_22", "IPNetwork         ", 20, "", data),
                IntegerWidget(     "int_val_22", "Integer           ", 20, "", data),
                FloatWidget(     "float_val_22", "Float             ", 20, "", data),
