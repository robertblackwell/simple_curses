...
def test_view(lines, lb):
    ...
    v2 = lines[lb.view_content_y_begin: lb.view_content_y_end + 1]
    return comp(v1, v2)
...
class TestMultiLinesBuffer(unittest.TestCase):
    ...
    def test_multi_line_newline(self):
        ...
        self.assertEqual(lb.cpos_y_content, 6)
        self.assertEqual(lb.cpos_y_buffer, 4)
        self.assertEqual(lb.view_content_y_begin, 2)
        self.assertEqual(lb.view_content_y_end, 6)
        self.assertEqual(lb.cpos_x_buffer, 0)
        self.assertEqual(lb.cpos_x_content, 0)
    ...
    def test_multi_line_buffer_addline(self):
        ...
        self.assertEqual(lb.view_content_y_begin, 0)
        self.assertEqual(lb.view_content_y_end, 0)
        self.assertEqual(lb.cpos_x_buffer, 0)
        self.assertEqual(lb.cpos_x_content, 0)
        ...
        self.assertEqual(lb.view_content_y_begin, 0)
        self.assertEqual(lb.view_content_y_end, 1)
        self.assertEqual(lb.cpos_x_buffer, 0)
        self.assertEqual(lb.cpos_x_content, 0)
    ...
    def test_multi_line_buffer_addline_in_constructor(self):
        ...
        self.assertEqual(lb.cpos_y_buffer, 2)
        self.assertEqual(lb.view_content_y_begin, 0)
        self.assertEqual(lb.view_content_y_end, 2)
        self.assertEqual(lb.cpos_x_buffer, 0)
        self.assertEqual(lb.cpos_x_content, 0)
        # self.assertTrue(test_view(lines, lb))
        lb.append_line(lines[2])
        ...
        self.assertEqual(lb.cpos_y_buffer, 3)
        self.assertEqual(lb.view_content_y_begin, 0)
        self.assertEqual(lb.view_content_y_end, 3)
        self.assertEqual(lb.cpos_x_buffer, 0)
        self.assertEqual(lb.cpos_x_content, 0)
        # self.assertTrue(test_view(lines[1:3], lb))
    ...
    def test_multi_lines_buffer_up_down01(self):
        ...
        self.assertEqual(lb.cpos_y_buffer, 4)
        self.assertEqual(lb.view_content_y_begin, 13)
        self.assertEqual(lb.view_content_y_end, 17)
        self.assertEqual(lb.cpos_x_buffer, 0)
        self.assertEqual(lb.cpos_x_content, 0)
        self.assertTrue(test_view(lines, lb))
        lb.handle_up()
        ...
        self.assertEqual(lb.cpos_y_buffer, 0)
        self.assertEqual(lb.view_content_y_begin, 12)
        self.assertEqual(lb.view_content_y_end, 16)
        self.assertEqual(lb.cpos_x_buffer, 0)
        self.assertEqual(lb.cpos_x_content, 0)
        self.assertTrue(test_view(lines, lb))
        lb.handle_up()
        ...
        self.assertEqual(lb.cpos_y_buffer, 0)
        self.assertEqual(lb.view_content_y_begin, 11)
        self.assertEqual(lb.view_content_y_end, 15)
        self.assertEqual(lb.cpos_x_buffer, 0)
        self.assertEqual(lb.cpos_x_content, 0)
        self.assertTrue(test_view(lines, lb))
        lb.handle_up()
        ...
        self.assertEqual(lb.cpos_y_buffer, 0)
        self.assertEqual(lb.view_content_y_begin, 9)
        self.assertEqual(lb.view_content_y_end, 13)
        self.assertEqual(lb.cpos_x_buffer, 0)
        self.assertEqual(lb.cpos_x_content, 0)
        self.assertTrue(test_view(lines, lb))
        lb.handle_down()
